...
<div id="menu-top">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="menu-settings">
            <li class="<?=$this->uri(1, '', 'active')?>"><a href="/"><i class="fa fa-play"></i> Lecture</a></li>
...
<div id="menu-bottom">
    <ul>
        <li id="open-panel-sx"><a href="/#panel-sx"<?=$this->uri(1, '', ' class="open-panel-sx" data-toggle="tab"')?>><i class="fa fa-music"></i> Bibliothèque</a></li>
        <li id="open-playback"<?=$this->uri(1, '', ' class="active"')?>><a href="/#playback"<?=$this->uri(1, '', ' data-toggle="tab"')?>><i class="fa fa-play"></i> Lecture</a></li>
        <li id="open-panel-dx"><a href="/#panel-dx"<?=$this->uri(1, '', ' class="open-panel-dx" data-toggle="tab"')?>><i class="fa fa-list"></i> File</a></li>
    </ul>
</div>
